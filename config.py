...
class Config:
    ...
    launches_rss_feeds: str = "https://www.gsmarena.com/rss-news-reviews.php3,https://techcrunch.com/category/gadgets/feed/"
    geopolitics_rss_feeds: str = "https://timesofindia.indiatimes.com/rssfeeds/296589292.cms"
    democracy_rss_feeds: str = "https://www.idea.int/rss.xml"
    entertainment_rss_feeds: str = "https://variety.com/feed/"
    enable_cricket_category: bool = True
    enable_technology_category: bool = True
    enable_launches_category: bool = True
    enable_geopolitics_category: bool = True
    enable_democracy_category: bool = True
    enable_entertainment_category: bool = True
    ...
    def load_from_env(cls, env_path: Optional[str] = None, validate: bool = True) -> "Config":
        ...
        config = cls(
            ...
            launches_rss_feeds=os.getenv("INSTAGRAM_LAUNCHES_RSS_FEEDS", "https://www.gsmarena.com/rss-news-reviews.php3,https://techcrunch.com/category/gadgets/feed/").strip(),
            geopolitics_rss_feeds=os.getenv("INSTAGRAM_GEOPOLITICS_RSS_FEEDS", "https://timesofindia.indiatimes.com/rssfeeds/296589292.cms").strip(),
            democracy_rss_feeds=os.getenv("INSTAGRAM_DEMOCRACY_RSS_FEEDS", "https://www.idea.int/rss.xml").strip(),
            entertainment_rss_feeds=os.getenv("INSTAGRAM_ENTERTAINMENT_RSS_FEEDS", "https://variety.com/feed/").strip(),
            enable_cricket_category=os.getenv("ENABLE_CRICKET_CATEGORY", "true").strip().lower() in ("true", "1", "yes", "on"),
            enable_technology_category=os.getenv("ENABLE_TECHNOLOGY_CATEGORY", "true").strip().lower() in ("true", "1", "yes", "on"),
            enable_launches_category=os.getenv("ENABLE_LAUNCHES_CATEGORY", "true").strip().lower() in ("true", "1", "yes", "on"),
            enable_geopolitics_category=os.getenv("ENABLE_GEOPOLITICS_CATEGORY", "true").strip().lower() in ("true", "1", "yes", "on"),
            enable_democracy_category=os.getenv("ENABLE_DEMOCRACY_CATEGORY", "true").strip().lower() in ("true", "1", "yes", "on"),
            enable_entertainment_category=os.getenv("ENABLE_ENTERTAINMENT_CATEGORY", "true").strip().lower() in ("true", "1", "yes", "on"),
